    ...
    return <div className="min-h-screen bg-white">
        ...
        <footer className="w-full bg-white py-4 sm:py-6 border-t border-gray-200 shadow-[0_-2px_12px_0_rgba(0,0,0,0.04)] flex flex-col md:flex-row items-center md:justify-between justify-center gap-2 sm:gap-4 text-gray-600 font-medium text-base sm:text-lg mt-13 sm:mt-20 px-4 sm:px-6">
            <div className="flex items-center gap-2">
                <span>Made with <span aria-label="love" role="img">❤️</span> by <span className="font-semibold">Mridul</span></span>
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
                <a href="https://github.com/Mridulklra" target="_blank" rel="noopener noreferrer" aria-label="Github" className="hover:text-black transition-colors">
                    <span style={{ width: '28px', height: '28px', display: 'inline-block' }}><GithubIcon /></span>
                </a>
                <a href="https://linkedin.com/in/Mridul%20kalra/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-700 transition-colors">
